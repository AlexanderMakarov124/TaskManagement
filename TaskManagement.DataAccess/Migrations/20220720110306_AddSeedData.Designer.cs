...
namespace TaskManagement.DataAccess.Migrations
{
    ...
    [Migration("20220720110306_AddSeedData")]
            ...
            modelBuilder.Entity("TaskManagement.Domain.Models.Issue", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 7, 20, 11, 3, 5, 908, DateTimeKind.Utc).AddTicks(2577),
                            Deadline = new DateTime(2022, 7, 27, 11, 3, 5, 908, DateTimeKind.Utc).AddTicks(2550),
